...
class MainWindow(QtGui.QMainWindow):
    ...
    def __init__(self): 
        ...
        self.p = subprocess.Popen(os.path.dirname(os.path.abspath(sys.argv[0])) +"/../usr/local/apache2/bin/httpd1.exe" ,startupinfo=startupinfo)
        self.p = subprocess.Popen(os.path.dirname(os.path.abspath(sys.argv[0])) +"/../usr/local/mysql/bin/mysqld1.exe" ,startupinfo=startupinfo)
...
class MainFrame(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.browser = cefpython.CreateBrowserSync(windowInfo,
                browserSettings={},
                navigateUrl=GetApplicationPath("http://127.0.0.1/us_phpmyadmin"))
        self.show()
